...
export var Page = function () {
    ...
    return (<article>
      <Header user={user} onLogin={function () { return setUser({ name: 'Jane Doe' }); }} onLogout={function () { return setUser(undefined); }} onCreateAccount={function () { return setUser({ name: 'Jane Doe' }); }}/>
